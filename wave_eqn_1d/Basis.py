...
class GaussLegendre:
	def __init__(self,n):
		...
		if n == 2:
			...
			self.x = np.array([-0.9324695142031520278123,-0.661209386466264513661,-0.2386191860831969086305,\
                                0.238619186083196908631,0.661209386466264513661,0.9324695142031520278123])
			self.w = np.array([0.1713244923791703450403,0.3607615730481386075698,0.4679139345726910473899,\
